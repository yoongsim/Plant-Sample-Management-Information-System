...
try:
    cur.execute("UPDATE " + table + " SET " + attribute + " = '" + new_value +"' WHERE "+ attribute + " = '" + value+ "'")
    count = cur.rowcount
    if count == 0:
        message = "No Data Updated"
        message2 = "Please recheck your input"

    else:
        message = "Data Updated Successfully"
        message2 = "Please proceed to retrieve data to view updated data"
...
print"<h3><b>%s</b></h3>" %message
print"<h3><b>%s</b></h3>" %message2
print"</div><br>"
print"<br><br></div>"
